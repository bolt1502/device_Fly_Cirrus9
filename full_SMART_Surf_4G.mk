...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/proprietary/lib/libmdfx.so:system/lib/libmdfx.so \
...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=SMART-Surf
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_MODEL=SMART-Surf
